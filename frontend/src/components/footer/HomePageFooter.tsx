...
export function HomePageFooter({ level1Categories, isLoading, error }: HomePageFooterProps) {
  ...
  return (
    <footer className="border-t border-slate-200/80 bg-white/90" aria-label="Site footer">
      <div className="mx-auto min-w-0 w-full max-w-7xl px-4 py-8 md:px-6 md:py-10">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <nav className="min-w-0" aria-label="Shop departments">
        ...
        <p className="mt-8 border-t border-slate-200/80 pt-6 text-center text-xs text-slate-500 sm:text-left">
          © {year} Multi-Store Ecommerce Platform
        </p>
      </div>
    </footer>
  )
